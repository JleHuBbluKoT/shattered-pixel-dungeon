...
import com.shatteredpixel.muscledungeon.items.weapon.missiles.darts.PoisonDart;
			...
			if (Dungeon.level.heroFOV[pos] || Dungeon.level.heroFOV[target.pos]) {
				Actor.add(new Actor() {
					...
					protected boolean act() {
						...
						((MissileSprite) PixelDungeonsAndShadowDragons.scene().recycle(MissileSprite.class)).
