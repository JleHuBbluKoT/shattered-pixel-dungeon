...
package com.shatteredpixel.muscledungeon.actors;
...
import com.shatteredpixel.muscledungeon.actors.buffs.Adrenaline;
...
import com.shatteredpixel.muscledungeon.actors.buffs.Corruption;
import com.shatteredpixel.muscledungeon.actors.buffs.Cripple;
import com.shatteredpixel.muscledungeon.actors.buffs.Doom;
import com.shatteredpixel.muscledungeon.actors.buffs.EarthImbue;
...
import com.shatteredpixel.muscledungeon.actors.buffs.Haste;
import com.shatteredpixel.muscledungeon.actors.buffs.Hunger;
import com.shatteredpixel.muscledungeon.actors.buffs.MagicalSleep;
...
import com.shatteredpixel.muscledungeon.actors.buffs.Preparation;
import com.shatteredpixel.muscledungeon.actors.buffs.ShieldBuff;
import com.shatteredpixel.muscledungeon.actors.buffs.Slow;
import com.shatteredpixel.muscledungeon.actors.buffs.Speed;
import com.shatteredpixel.muscledungeon.actors.buffs.Stamina;
import com.shatteredpixel.muscledungeon.actors.buffs.Terror;
...
import com.shatteredpixel.muscledungeon.items.BrokenSeal;
import com.shatteredpixel.muscledungeon.items.armor.glyphs.Brimstone;
import com.shatteredpixel.muscledungeon.items.armor.glyphs.Potential;
...
import com.shatteredpixel.muscledungeon.items.scrolls.exotic.ScrollOfPsionicBlast;
...
import com.shatteredpixel.muscledungeon.items.weapon.enchantments.Blazing;
import com.shatteredpixel.muscledungeon.items.weapon.enchantments.Grim;
import com.shatteredpixel.muscledungeon.items.weapon.enchantments.Shocking;
import com.shatteredpixel.muscledungeon.items.weapon.missiles.MissileWeapon;
import com.shatteredpixel.muscledungeon.items.weapon.missiles.darts.ShockingDart;
import com.shatteredpixel.muscledungeon.levels.Terrain;
import com.shatteredpixel.muscledungeon.levels.features.Chasm;
import com.shatteredpixel.muscledungeon.levels.features.Door;
...
public abstract class Char extends Actor {
    ...
    private HashSet<Magic> magics = new HashSet<>();
    ...
    protected static final String MAGICS    = "magics";
    ...
    public synchronized HashSet<Magic> magics() {
        return new HashSet<>(magics);
    }

    @SuppressWarnings("unchecked")
    public synchronized <T extends Magic> HashSet<T> magics( Class<T> c ) {
        HashSet<T> filtered = new HashSet<>();
        for (Magic m : magics) {
            if (c.isInstance( m )) {
                filtered.add( (T)m );
    ...
    @SuppressWarnings("unchecked")
    public synchronized  <T extends Magic> T magic( Class<T> c ) {
        for (Magic m : magics) {
            if (c.isInstance( m )) {
                return (T)m;
            }
    ...
    public synchronized void addMagic( Magic magic ) {
    ...
    public synchronized void removeMagic( Magic magic ) {
    ...
    public synchronized void removeMagic( Class<? extends Magic> magicClass ) {
        for (Magic magic : magics( magicClass )) {
            remove( magic );
        }
    }
