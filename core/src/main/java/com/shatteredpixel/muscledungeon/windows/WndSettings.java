...
import com.shatteredpixel.muscledungeon.ui.CheckBox;
import com.shatteredpixel.muscledungeon.ui.OptionSlider;
			...
			OptionSlider scale = new OptionSlider(Messages.get(this, "scale"),
				...
				protected void onChange() {
					if (getSelectedValue() != SPDSettings.scale()) {
						...
						PixelDungeonsAndShadowDragons.switchNoFade((Class<? extends PixelScene>) PixelDungeonsAndShadowDragons.scene().getClass(), new Game.SceneChangeCallback() {
							@Override
