...
public class WndTextInput extends Window {
	...
	public WndTextInput(final String title, final String initialValue, final int maxLength,
		...
		PixelDungeonsAndShadowDragons.instance.runOnUiThread(new Runnable() {
			@Override
			public void run() {
				...
				textInput = new EditText(PixelDungeonsAndShadowDragons.instance);
				...
				PixelDungeonsAndShadowDragons.instance.addContentView(textInput, layout);
			}
		});
	}
		...
		if (textInput != null){
			PixelDungeonsAndShadowDragons.instance.runOnUiThread(new Runnable() {
				...
				public void run() {
					...
					InputMethodManager imm = (InputMethodManager) PixelDungeonsAndShadowDragons
					...
					PixelDungeonsAndShadowDragons.updateSystemUI();
