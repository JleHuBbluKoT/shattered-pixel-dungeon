...
import com.shatteredpixel.muscledungeon.windows.WndGameInProgress;
...
public class StartScene extends PixelScene {
	...
	private static class SaveSlotButton extends Button {
		...
		protected void onClick() {
			if (newGame) {
				PixelDungeonsAndShadowDragons.scene().add( new WndStartGame(slot));
			} else {
				PixelDungeonsAndShadowDragons.scene().add( new WndGameInProgress(slot));
			}
		}
	}
}
