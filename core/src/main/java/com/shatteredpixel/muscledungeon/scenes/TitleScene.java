...
import com.shatteredpixel.muscledungeon.ui.ChangesButton;
import com.shatteredpixel.muscledungeon.ui.ExitButton;
import com.shatteredpixel.muscledungeon.ui.LanguageButton;
import com.shatteredpixel.muscledungeon.ui.PrefsButton;
	...
	public void create() {
		...
		DashboardItem btnBadges = new DashboardItem( Messages.get(this, "badges"), 3 ) {
			...
			protected void onClick() {
				PixelDungeonsAndShadowDragons.switchNoFade( BadgesScene.class );
			}
		};
		add(btnBadges);
		...
		DashboardItem btnAbout = new DashboardItem( Messages.get(this, "about"), 1 ) {
			@Override
			protected void onClick() {
				PixelDungeonsAndShadowDragons.switchNoFade( AboutScene.class );
			}
		};
		add( btnAbout );
		...
		DashboardItem btnPlay = new DashboardItem( Messages.get(this, "play"), 0 ) {
			...
			protected void onClick() {
				if (GamesInProgress.checkAll().size() == 0){
					...
					PixelDungeonsAndShadowDragons.switchNoFade( StartScene.class );
				}
			}
		...
		DashboardItem btnRankings = new DashboardItem( Messages.get(this, "rankings"), 2 ) {
			@Override
			protected void onClick() {
				PixelDungeonsAndShadowDragons.switchNoFade( RankingsScene.class );
			}
		};
		add( btnRankings );
